package com.siri.travelguidemultiswipedbrealtime.util

import android.graphics.Canvas
import androidx.recyclerview.widget.ItemTouchHelper
import androidx.recyclerview.widget.RecyclerView
import com.siri.travelguidemultiswipedbrealtime.module.adapter.SwipeAdapter
import com.siri.travelguidemultiswipedbrealtime.listener.OnItemSwipeListener.SwipeDirection
...
internal class SwipeTouchHelper(
    ...
    override fun getSwipeThreshold(viewHolder: RecyclerView.ViewHolder): Float {
        ...
        if (recyclerViewWidth != null && recyclerViewHeight != null) {
            val isSwipingHorizontally = (mOrientation.flagsswipeVal and DirectionFlag.RIGHT.value == DirectionFlag.RIGHT.value)
                    || (mOrientation.flagsswipeVal and DirectionFlag.LEFT.value == DirectionFlag.LEFT.value)
